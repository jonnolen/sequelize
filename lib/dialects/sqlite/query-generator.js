    ...
    for (var name in attributes) {
      ...
      if (Utils._.isObject(dataType)) {
        ...
        if(dataType.references) {
          ...
          var tableName = this.addSchema({
            tableName: dataType.references.model,
            schema: dataType.references.schema
          });
          replacements.referencesTable = this.quoteTable(tableName);
